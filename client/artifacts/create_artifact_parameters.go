...
// WithArtifactResource adds the artifactResource to the create artifact params
func (o *CreateArtifactParams) WithArtifactResource(artifactResource *models.ArtifactResource) *CreateArtifactParams {
	o.SetArtifactResource(artifactResource)
	return o
}

// SetArtifactResource adds the artifactResource to the create artifact params
func (o *CreateArtifactParams) SetArtifactResource(artifactResource *models.ArtifactResource) {
