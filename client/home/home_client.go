...
type ClientService interface {
	GetHome(params *GetHomeParams) (*GetHomeOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
  GetHome Returns a document describing the current Octopus Server and links to other parts of the API.
*/
func (a *Client) GetHome(params *GetHomeParams) (*GetHomeOK, error) {
