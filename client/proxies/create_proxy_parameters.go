...
// WithProxyResource adds the proxyResource to the create proxy params
func (o *CreateProxyParams) WithProxyResource(proxyResource *models.ProxyResource) *CreateProxyParams {
	o.SetProxyResource(proxyResource)
	return o
}

// SetProxyResource adds the proxyResource to the create proxy params
func (o *CreateProxyParams) SetProxyResource(proxyResource *models.ProxyResource) {
