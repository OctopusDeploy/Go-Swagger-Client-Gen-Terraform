...
// WithAccountResource adds the accountResource to the create account params
func (o *CreateAccountParams) WithAccountResource(accountResource *models.AccountResource) *CreateAccountParams {
	o.SetAccountResource(accountResource)
	return o
}

// SetAccountResource adds the accountResource to the create account params
func (o *CreateAccountParams) SetAccountResource(accountResource *models.AccountResource) {
