...
func (o *CreateAccountCreated) Error() string {
	return fmt.Sprintf("[POST /api/accounts][%d] createAccountCreated  %+v", 201, o.Payload)
}

func (o *CreateAccountCreated) GetPayload() *models.AccountResource {
	return o.Payload
}
...
func (o *CreateAccountBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/accounts][%d] createAccountBadRequest ", 400)
}
