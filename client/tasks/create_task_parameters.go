...
// WithTaskResource adds the taskResource to the create task params
func (o *CreateTaskParams) WithTaskResource(taskResource *models.TaskResource) *CreateTaskParams {
	o.SetTaskResource(taskResource)
	return o
}

// SetTaskResource adds the taskResource to the create task params
func (o *CreateTaskParams) SetTaskResource(taskResource *models.TaskResource) {
