...
func (o *UpdateReleaseOK) Error() string {
	return fmt.Sprintf("[PUT /api/releases/{id}][%d] updateReleaseOK  %+v", 200, o.Payload)
}

func (o *UpdateReleaseOK) GetPayload() *models.ReleaseResource {
	return o.Payload
}
...
func (o *UpdateReleaseBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/releases/{id}][%d] updateReleaseBadRequest ", 400)
}
