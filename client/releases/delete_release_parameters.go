...
// WithID adds the id to the delete release params
func (o *DeleteReleaseParams) WithID(id string) *DeleteReleaseParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete release params
func (o *DeleteReleaseParams) SetID(id string) {
	o.ID = id
}
