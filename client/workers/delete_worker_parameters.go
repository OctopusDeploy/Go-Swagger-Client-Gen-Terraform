...
// WithID adds the id to the delete worker params
func (o *DeleteWorkerParams) WithID(id string) *DeleteWorkerParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete worker params
func (o *DeleteWorkerParams) SetID(id string) {
	o.ID = id
}
