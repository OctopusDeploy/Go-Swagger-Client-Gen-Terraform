...
// WithProjectResource adds the projectResource to the create project params
func (o *CreateProjectParams) WithProjectResource(projectResource *models.ProjectResource) *CreateProjectParams {
	o.SetProjectResource(projectResource)
	return o
}

// SetProjectResource adds the projectResource to the create project params
func (o *CreateProjectParams) SetProjectResource(projectResource *models.ProjectResource) {
	o.ProjectResource = projectResource
}

// WithClone adds the clone to the create project params
func (o *CreateProjectParams) WithClone(clone *string) *CreateProjectParams {
	o.SetClone(clone)
	return o
}

// SetClone adds the clone to the create project params
func (o *CreateProjectParams) SetClone(clone *string) {
	o.Clone = clone
}
