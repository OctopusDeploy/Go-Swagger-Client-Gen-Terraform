...
// WithProjectResource adds the projectResource to the update project params
func (o *UpdateProjectParams) WithProjectResource(projectResource *models.ProjectResource) *UpdateProjectParams {
	o.SetProjectResource(projectResource)
	return o
}

// SetProjectResource adds the projectResource to the update project params
func (o *UpdateProjectParams) SetProjectResource(projectResource *models.ProjectResource) {
