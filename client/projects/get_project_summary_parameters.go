...
// WithID adds the id to the get project summary params
func (o *GetProjectSummaryParams) WithID(id string) *GetProjectSummaryParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get project summary params
func (o *GetProjectSummaryParams) SetID(id string) {
	o.ID = id
}
