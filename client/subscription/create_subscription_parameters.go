...
// WithSubscriptionResource adds the subscriptionResource to the create subscription params
func (o *CreateSubscriptionParams) WithSubscriptionResource(subscriptionResource *models.SubscriptionResource) *CreateSubscriptionParams {
	o.SetSubscriptionResource(subscriptionResource)
	return o
}

// SetSubscriptionResource adds the subscriptionResource to the create subscription params
func (o *CreateSubscriptionParams) SetSubscriptionResource(subscriptionResource *models.SubscriptionResource) {
