...
// WithSubscriptionResource adds the subscriptionResource to the update subscription params
func (o *UpdateSubscriptionParams) WithSubscriptionResource(subscriptionResource *models.SubscriptionResource) *UpdateSubscriptionParams {
	o.SetSubscriptionResource(subscriptionResource)
	return o
}

// SetSubscriptionResource adds the subscriptionResource to the update subscription params
func (o *UpdateSubscriptionParams) SetSubscriptionResource(subscriptionResource *models.SubscriptionResource) {
