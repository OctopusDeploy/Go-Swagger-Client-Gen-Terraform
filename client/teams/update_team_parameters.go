...
// WithTeamResource adds the teamResource to the update team params
func (o *UpdateTeamParams) WithTeamResource(teamResource *models.TeamResource) *UpdateTeamParams {
	o.SetTeamResource(teamResource)
	return o
}

// SetTeamResource adds the teamResource to the update team params
func (o *UpdateTeamParams) SetTeamResource(teamResource *models.TeamResource) {
