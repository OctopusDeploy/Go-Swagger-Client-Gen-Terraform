...
// WithTeamResource adds the teamResource to the create team params
func (o *CreateTeamParams) WithTeamResource(teamResource *models.TeamResource) *CreateTeamParams {
	o.SetTeamResource(teamResource)
	return o
}

// SetTeamResource adds the teamResource to the create team params
func (o *CreateTeamParams) SetTeamResource(teamResource *models.TeamResource) {
