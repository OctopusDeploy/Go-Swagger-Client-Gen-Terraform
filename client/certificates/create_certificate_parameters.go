...
// WithCertificateResource adds the certificateResource to the create certificate params
func (o *CreateCertificateParams) WithCertificateResource(certificateResource *models.CertificateResource) *CreateCertificateParams {
	o.SetCertificateResource(certificateResource)
	return o
}

// SetCertificateResource adds the certificateResource to the create certificate params
func (o *CreateCertificateParams) SetCertificateResource(certificateResource *models.CertificateResource) {
