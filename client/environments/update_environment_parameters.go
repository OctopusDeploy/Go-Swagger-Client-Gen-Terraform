...
// WithEnvironmentResource adds the environmentResource to the update environment params
func (o *UpdateEnvironmentParams) WithEnvironmentResource(environmentResource *models.EnvironmentResource) *UpdateEnvironmentParams {
	o.SetEnvironmentResource(environmentResource)
	return o
}

// SetEnvironmentResource adds the environmentResource to the update environment params
func (o *UpdateEnvironmentParams) SetEnvironmentResource(environmentResource *models.EnvironmentResource) {
	o.EnvironmentResource = environmentResource
}

// WithID adds the id to the update environment params
func (o *UpdateEnvironmentParams) WithID(id string) *UpdateEnvironmentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update environment params
func (o *UpdateEnvironmentParams) SetID(id string) {
	o.ID = id
}
