...
// WithChannelResource adds the channelResource to the create channel params
func (o *CreateChannelParams) WithChannelResource(channelResource *models.ChannelResource) *CreateChannelParams {
	o.SetChannelResource(channelResource)
	return o
}

// SetChannelResource adds the channelResource to the create channel params
func (o *CreateChannelParams) SetChannelResource(channelResource *models.ChannelResource) {
