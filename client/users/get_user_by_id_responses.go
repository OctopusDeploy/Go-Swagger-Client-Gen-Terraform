...
func (o *GetUserByIDOK) Error() string {
	return fmt.Sprintf("[GET /api/users/{id}][%d] getUserByIdOK  %+v", 200, o.Payload)
}

func (o *GetUserByIDOK) GetPayload() *models.UserResource {
	return o.Payload
}
...
func (o *GetUserByIDBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/users/{id}][%d] getUserByIdBadRequest ", 400)
}
