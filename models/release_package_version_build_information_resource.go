...
// ReleasePackageVersionBuildInformationResource release package version build information resource
//
// swagger:model ReleasePackageVersionBuildInformationResource
type ReleasePackageVersionBuildInformationResource struct {
...
// Validate validates this release package version build information resource
func (m *ReleasePackageVersionBuildInformationResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReleasePackageVersionBuildInformationResource) validateCommits(formats strfmt.Registry) error {
...
func (m *ReleasePackageVersionBuildInformationResource) validateWorkItems(formats strfmt.Registry) error {
...
func (m *ReleasePackageVersionBuildInformationResource) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReleasePackageVersionBuildInformationResource) UnmarshalBinary(b []byte) error {
	var res ReleasePackageVersionBuildInformationResource
