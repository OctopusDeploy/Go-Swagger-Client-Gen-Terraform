...
type Project struct {
	...
	// variables
	Variables map[string]map[string]PropertyValueResource `json:"Variables,omitempty"`
}
...
func (m *Project) validateVariables(formats strfmt.Registry) error {
	...
	for k := range m.Variables {
		...
		for kk := range m.Variables[k] {

			if err := validate.Required("Variables"+"."+k+"."+kk, "body", m.Variables[k][kk]); err != nil {
				return err
			}
			if val, ok := m.Variables[k][kk]; ok {
