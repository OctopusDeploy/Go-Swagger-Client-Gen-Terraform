...
func (m *PackageResource) validatePackageVersionBuildInformation(formats strfmt.Registry) error {
...
func (m *PackageResource) validatePublished(formats strfmt.Registry) error {
